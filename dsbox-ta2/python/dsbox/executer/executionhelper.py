...
class ExecutionHelper(object):
    ...
    def instantiate_primitive_imputation(self, primitive, imputation):
        executable = None
        # Parse arguments
        args = []
        kwargs = {}
    ...
    def execute_primitive_imputation(self, primitive, df, df_lbl, imputation, cur_profile=None):
        primitive.start_time = time.time()
        persistent = primitive.is_persistent
        indices = df.index
